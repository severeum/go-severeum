...
nested arrays of binary data, and RLP is the main encoding msevod used
to serialize objects in Severeum. The only purpose of RLP is to encode
structure; encoding specific atomic data types (eg. strings, ints,
floats) is left up to higher-order protocols; in Severeum integers
