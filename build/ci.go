...
import (
	...
	"github.com/severeum/go-severeum/internal/build"
	"github.com/severeum/go-severeum/params"
	sv "github.com/severeum/go-severeum/swarm/version"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			BinaryName:  "abigen",
			Description: "Source code generator to convert Severeum contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			BinaryName:  "bootnode",
			Description: "Severeum bootnode.",
		},
		{
			BinaryName:  "evm",
		...
		{
			BinaryName:  "wnode",
			Description: "Severeum Whisper diagnostic tool",
		},
	}
	...
	debSwarmExecutables = []debExecutable{
		{
			BinaryName:  "swarm",
			PackageName: "severeum-swarm",
			Description: "Severeum Swarm daemon and tools",
		},
	}

	debSevereum = debPackage{
		Name:        "severeum",
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 9 {
			...
			log.Println("go-severeum requires at least Go version 1.9 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:severeum/severeum")`)
...
type debPackage struct {
	Name        string          // the name of the Debian package to produce, e.g. "severeum", or "severeum-swarm"
...
type debMetadata struct {
	...
	// go-severeum version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time, name string, version string, exes []debExecutable) debMetadata {
	if author == "" {
		...
		author = "Severeum Builds <fjl@severeum.org>"
	}
	return debMetadata{
		PackageName: name,
		Env:         env,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.severeum", "-v", "github.com/severeum/go-severeum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/severeum/go-severeum/mobile")
