...
// Package accounts implements high level Severeum account management.
package accounts
...
// Account represents an Severeum account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Severeum account address derived from the key
...
type Wallet interface {
	...
	// particular wallet instance. The reason there is no passwordless open msevod
	...
	// Contains returns whsever an account is part of this particular wallet or not.
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain severeum.ChainStateReader)
