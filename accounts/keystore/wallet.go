...
// Status implements accounts.Wallet, returning whsever the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain severeum.ChainStateReader) {}
