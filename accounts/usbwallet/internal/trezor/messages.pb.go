...
const (
	...
	MessageType_MessageType_SevereumGetAddress       MessageType = 56
	MessageType_MessageType_SevereumAddress          MessageType = 57
	MessageType_MessageType_SevereumSignTx           MessageType = 58
	MessageType_MessageType_SevereumTxRequest        MessageType = 59
	MessageType_MessageType_SevereumTxAck            MessageType = 60
	...
	MessageType_MessageType_SevereumSignMessage      MessageType = 64
	MessageType_MessageType_SevereumVerifyMessage    MessageType = 65
	MessageType_MessageType_SevereumMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_SevereumGetAddress",
	57:  "MessageType_SevereumAddress",
	58:  "MessageType_SevereumSignTx",
	59:  "MessageType_SevereumTxRequest",
	60:  "MessageType_SevereumTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_SevereumSignMessage",
	65:  "MessageType_SevereumVerifyMessage",
	66:  "MessageType_SevereumMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_SevereumGetAddress":       56,
	"MessageType_SevereumAddress":          57,
	"MessageType_SevereumSignTx":           58,
	"MessageType_SevereumTxRequest":        59,
	"MessageType_SevereumTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_SevereumSignMessage":      64,
	"MessageType_SevereumVerifyMessage":    65,
	"MessageType_SevereumMessageSignature": 66,
...
// *
// Request: Ask device for Severeum address corresponding to address_n path
// @next PassphraseRequest
// @next SevereumAddress
// @next Failure
type SevereumGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *SevereumGetAddress) Reset()                    { *m = SevereumGetAddress{} }
func (m *SevereumGetAddress) String() string            { return proto.CompactTextString(m) }
func (*SevereumGetAddress) ProtoMessage()               {}
func (*SevereumGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *SevereumGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SevereumGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Severeum address derived from device private seed
// @prev SevereumGetAddress
type SevereumAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SevereumAddress) Reset()                    { *m = SevereumAddress{} }
func (m *SevereumAddress) String() string            { return proto.CompactTextString(m) }
func (*SevereumAddress) ProtoMessage()               {}
func (*SevereumAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *SevereumAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type RecoveryDevice struct {
	...
	// 7 reserved for unused recovery msevod
...
// This msevod doesn't support streaming, so there are hardware limits in number of inputs and outputs.
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next SevereumTxRequest
// @next Failure
type SevereumSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *SevereumSignTx) Reset()                    { *m = SevereumSignTx{} }
func (m *SevereumSignTx) String() string            { return proto.CompactTextString(m) }
func (*SevereumSignTx) ProtoMessage()               {}
func (*SevereumSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *SevereumSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SevereumSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *SevereumSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *SevereumSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *SevereumSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *SevereumSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *SevereumSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *SevereumSignTx) GetDataLength() uint32 {
...
func (m *SevereumSignTx) GetChainId() uint32 {
...
func (m *SevereumTxRequest) Reset()                    { *m = SevereumTxRequest{} }
func (m *SevereumTxRequest) String() string            { return proto.CompactTextString(m) }
func (*SevereumTxRequest) ProtoMessage()               {}
func (*SevereumTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *SevereumTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *SevereumTxRequest) GetSignatureV() uint32 {
...
func (m *SevereumTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *SevereumTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev SevereumTxRequest
// @next SevereumTxRequest
type SevereumTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SevereumTxAck) Reset()                    { *m = SevereumTxAck{} }
func (m *SevereumTxAck) String() string            { return proto.CompactTextString(m) }
func (*SevereumTxAck) ProtoMessage()               {}
func (*SevereumTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *SevereumTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next SevereumMessageSignature
// @next Failure
type SevereumSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *SevereumSignMessage) Reset()                    { *m = SevereumSignMessage{} }
func (m *SevereumSignMessage) String() string            { return proto.CompactTextString(m) }
func (*SevereumSignMessage) ProtoMessage()               {}
func (*SevereumSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *SevereumSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *SevereumSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type SevereumVerifyMessage struct {
...
func (m *SevereumVerifyMessage) Reset()                    { *m = SevereumVerifyMessage{} }
func (m *SevereumVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*SevereumVerifyMessage) ProtoMessage()               {}
func (*SevereumVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *SevereumVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *SevereumVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *SevereumVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev SevereumSignMessage
type SevereumMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *SevereumMessageSignature) Reset()                    { *m = SevereumMessageSignature{} }
func (m *SevereumMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*SevereumMessageSignature) ProtoMessage()               {}
func (*SevereumMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *SevereumMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *SevereumMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*SevereumGetAddress)(nil), "SevereumGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*SevereumAddress)(nil), "SevereumAddress")
	...
	proto.RegisterType((*SevereumSignTx)(nil), "SevereumSignTx")
	proto.RegisterType((*SevereumTxRequest)(nil), "SevereumTxRequest")
	proto.RegisterType((*SevereumTxAck)(nil), "SevereumTxAck")
	proto.RegisterType((*SevereumSignMessage)(nil), "SevereumSignMessage")
	proto.RegisterType((*SevereumVerifyMessage)(nil), "SevereumVerifyMessage")
	proto.RegisterType((*SevereumMessageSignature)(nil), "SevereumMessageSignature")
