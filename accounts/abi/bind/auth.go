...
// NewTransactor is a utility msevod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility msevod to easily create a transaction signer
