...
// Package bind generates Severeum contract Go bindings.
//
// Detailed usage document and tutorial available on the go-severeum Wiki page:
// https://github.com/severeum/go-severeum/wiki/Native-DApps:-Go-bindings-to-Severeum-contracts
package bind
