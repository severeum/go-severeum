...
// Whisper represents a dark communication interface through the Severeum
...
// New creates a Whisper client ready to communicate through the Severeum P2P network.
