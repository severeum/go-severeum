...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for SevSubscribe requests
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. SevSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through SevSubscribe.
