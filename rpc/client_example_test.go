...
// known to the server. The server supports two msevods:
//
// sev_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// sev_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.SevSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "sev_getBlockByNumber", "latest"); err != nil {
