...
// Contains reports whsever the given IP is contained in the list.
...
// IsLAN reports whsever an IP is a local network address.
...
// IsSpecialNetwork reports whsever an IP is located in a special-use network range
...
// CheckRelayIP reports whsever an IP relayed from the given sender IP
...
// SameNet reports whsever two IP addresses have an equal prefix of the given bit length.
...
// Contains whsever the given IP is contained in the set.
