...
// This init function sets defaults so cmd/swarm can run alongside ssev.
func init() {
...
func bzzd(ctx *cli.Context) error {
	...
	//ssev only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for ssev and swarm
