...
var (
	walletCommand = cli.Command{
		...
		Description: `
    seth wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	seth wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    seth account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    seth account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := sethConfig{Node: defaultNodeConfig()}
	// Load config file.
