...
// bootnode runs a bootstrap node for the Severeum Discovery Protocol.
package main
...
func main() {
	var (
		listenAddr  = flag.String("addr", ":13336", "listen address")
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "severeum discovery")
		}
