...
type wizard struct {
	...
	services map[string][]string   // Severeum services known to be running on servers
...
// converts it to an Severeum address. If an empty line is entered, the default
// value is returned.
