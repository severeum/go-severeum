...
// Fuzz implements a go-fuzz fuzzer msevod to test various encoding msevod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer msevod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer msevod to test the bit decoding and
