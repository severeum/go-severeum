...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllSevashProtocolChanges, new: AllSevashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllSevashProtocolChanges, new: AllSevashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllSevashProtocolChanges,
