...
// The app's SubscribeResults msevod starts sending calculation results to the given
// channel. Subscriptions created through this msevod are tied to the lifetime of the App
