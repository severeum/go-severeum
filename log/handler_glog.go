...
type GlogHandler struct {
	...
	override  uint32 // Flag whsever overrides are used, atomically accessible
	backtrace uint32 // Flag whsever backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whsever this is the callsite
