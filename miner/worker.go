...
// setSeverbase sets the etherbase used to initialize the block coinbase field.
...
// commitNewWork generates etheral new sealing tasks based on the parent block.
