...
// Package miner implements Severeum block creation and mining.
package miner
...
func (self *Miner) SetSeverbase(addr common.Address) {
	self.coinbase = addr
	self.worker.setSeverbase(addr)
}
