...
// DeployENS deploys a new Severeum contract, binding an instance of ENS to it.
...
// ENS is an auto generated Go binding around an Severeum contract.
type ENS struct {
...
// ENSCaller is an auto generated read-only Go binding around an Severeum contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an Severeum contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSFilterer is an auto generated log filtering Go binding around an Severeum contract events.
type ENSFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an Severeum contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an Severeum contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an Severeum contract,
