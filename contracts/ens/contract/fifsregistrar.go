...
// DeployFIFSRegistrar deploys a new Severeum contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Severeum contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Severeum contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Severeum contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Severeum contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Severeum contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Severeum contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Severeum contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Severeum contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw msevods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Severeum contract.
type FIFSRegistrarCallerRaw struct {
	Contract *FIFSRegistrarCaller // Generic read-only contract binding to access the raw msevods on
}

// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Severeum contract.
type FIFSRegistrarTransactorRaw struct {
	Contract *FIFSRegistrarTransactor // Generic write-only contract binding to access the raw msevods on
}
...
// returns.
func (_FIFSRegistrar *FIFSRegistrarRaw) Call(opts *bind.CallOpts, result interface{}, msevod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.FIFSRegistrarCaller.contract.Call(opts, result, msevod, params...)
}
...
func (_FIFSRegistrar *FIFSRegistrarRaw) Transact(opts *bind.TransactOpts, msevod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.FIFSRegistrarTransactor.contract.Transact(opts, msevod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_FIFSRegistrar *FIFSRegistrarCallerRaw) Call(opts *bind.CallOpts, result interface{}, msevod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.contract.Call(opts, result, msevod, params...)
}
...
// Transact invokes the (paid) contract msevod with params as input values.
func (_FIFSRegistrar *FIFSRegistrarTransactorRaw) Transact(opts *bind.TransactOpts, msevod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.contract.Transact(opts, msevod, params...)
}

// Register is a paid mutator transaction binding the contract msevod 0xd22057a9.
//
