...
// DeployChequebook deploys a new Severeum contract, binding an instance of Chequebook to it.
...
// Chequebook is an auto generated Go binding around an Severeum contract.
...
// ChequebookCaller is an auto generated read-only Go binding around an Severeum contract.
type ChequebookCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookTransactor is an auto generated write-only Go binding around an Severeum contract.
type ChequebookTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookFilterer is an auto generated log filtering Go binding around an Severeum contract events.
type ChequebookFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ChequebookSession is an auto generated Go binding around an Severeum contract,
...
// ChequebookCallerSession is an auto generated read-only Go binding around an Severeum contract,
...
// ChequebookTransactorSession is an auto generated write-only Go binding around an Severeum contract,
...
// ChequebookRaw is an auto generated low-level Go binding around an Severeum contract.
type ChequebookRaw struct {
	Contract *Chequebook // Generic contract binding to access the raw msevods on
}

// ChequebookCallerRaw is an auto generated low-level read-only Go binding around an Severeum contract.
type ChequebookCallerRaw struct {
	Contract *ChequebookCaller // Generic read-only contract binding to access the raw msevods on
}

// ChequebookTransactorRaw is an auto generated low-level write-only Go binding around an Severeum contract.
type ChequebookTransactorRaw struct {
	Contract *ChequebookTransactor // Generic write-only contract binding to access the raw msevods on
}
...
// returns.
func (_Chequebook *ChequebookRaw) Call(opts *bind.CallOpts, result interface{}, msevod string, params ...interface{}) error {
	return _Chequebook.Contract.ChequebookCaller.contract.Call(opts, result, msevod, params...)
}
...
func (_Chequebook *ChequebookRaw) Transact(opts *bind.TransactOpts, msevod string, params ...interface{}) (*types.Transaction, error) {
	return _Chequebook.Contract.ChequebookTransactor.contract.Transact(opts, msevod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Chequebook *ChequebookCallerRaw) Call(opts *bind.CallOpts, result interface{}, msevod string, params ...interface{}) error {
	return _Chequebook.Contract.contract.Call(opts, result, msevod, params...)
}
...
// Transact invokes the (paid) contract msevod with params as input values.
func (_Chequebook *ChequebookTransactorRaw) Transact(opts *bind.TransactOpts, msevod string, params ...interface{}) (*types.Transaction, error) {
	return _Chequebook.Contract.contract.Transact(opts, msevod, params...)
}

// Sent is a free data retrieval call binding the contract msevod 0x7bf786f8.
//
...
// Cash is a paid mutator transaction binding the contract msevod 0xfbf788d6.
//
...
// Kill is a paid mutator transaction binding the contract msevod 0x41c0e1b5.
//
