...
import (
	...
	"github.com/severeum/go-severeum/crypto/bn256"
	"github.com/severeum/go-severeum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run msevod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Severeum
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Severeum
...
//
// This msevod does not require any overflow checking as the input size gas costs
