...
type operation struct {
	...
	halts   bool // indicates whsever the operation should halt further execution
	jumps   bool // indicates whsever the program counter should not increment
	writes  bool // determines whsever this a state modifying operation
	valid   bool // indication whsever the retrieved operation is valid and known
	reverts bool // determines whsever the operation reverts state (implicitly halts)
	returns bool // determines whsever the operations sets the return data content
}
