...
// stateObject represents an Severeum account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of severeum address of the account
	data     Account
	db       *StateDB
...
// Account is the Severeum consensus representation of accounts.
