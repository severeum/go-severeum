...
// Package state provides a caching layer atop the Severeum state trie.
package state
...
// StateDBs within the severeum protocol are used to store anything
...
//
// Carrying over the balance ensures that Sever doesn't disappear.
