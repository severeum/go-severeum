...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(sevdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db sevdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db sevdb.Database, root common.Hash) error {
...
func checkStateConsistency(db sevdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, sevdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(sevdb.Database), srcRoot)
