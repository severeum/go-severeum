...
func testSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	checkProgress(t, tester.downloader, "pristine", severeum.SyncProgress{})
	...
	<-starting
	checkProgress(t, tester.downloader, "initial", severeum.SyncProgress{
	...
	<-starting
	checkProgress(t, tester.downloader, "completing", severeum.SyncProgress{
	...
	progress <- struct{}{}
	pending.Wait()
	checkProgress(t, tester.downloader, "final", severeum.SyncProgress{
		StartingBlock: uint64(chain.len()/2 - 1),
...
func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode) {
	...
	<-starting
	checkProgress(t, tester.downloader, "forking", severeum.SyncProgress{
