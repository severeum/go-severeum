...
// It offers only msevods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the Severeum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  severeum.SyncProgress `json:"status"`
}
