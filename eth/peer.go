...
// PeerInfo represents a short summary of the Severeum sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Severeum protocol version negotiated
...
// Handshake executes the sev protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("sev/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the Severeum sub-protocol.
type peerSet struct {
