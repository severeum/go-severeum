...
// PublicSevereumAPI provides an API to access Severeum full node-related
// information.
type PublicSevereumAPI struct {
	e *Severeum
}

// NewPublicSevereumAPI creates a new Severeum protocol API for full nodes.
func NewPublicSevereumAPI(e *Severeum) *PublicSevereumAPI {
	return &PublicSevereumAPI{e}
}

// Severbase is the address that mining rewards will be send to
func (api *PublicSevereumAPI) Severbase() (common.Address, error) {
	return api.e.Severbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Severbase)
func (api *PublicSevereumAPI) Coinbase() (common.Address, error) {
	return api.Severbase()
}

// Hashrate returns the POW hashrate
func (api *PublicSevereumAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().HashRate())
}

// ChainId is the EIP-155 replay-protection chain id for the current severeum chain config.
func (api *PublicSevereumAPI) ChainId() hexutil.Uint64 {
	chainID := new(big.Int)
...
func NewPublicMinerAPI(e *Severeum) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Severeum) *PrivateMinerAPI {
...
// PrivateDebugAPI is the collection of Severeum full node APIs exposed over
