...
type accessTestFn func(db sevdb.Database, bhash common.Hash, number uint64) light.OdrRequest

func TestBlockAccessLes1(t *testing.T) { testAccess(t, 1, tfBlockAccess) }

func TestBlockAccessLes2(t *testing.T) { testAccess(t, 2, tfBlockAccess) }

func tfBlockAccess(db sevdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db sevdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db sevdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db sevdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
