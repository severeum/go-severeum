...
var (
	...
	// sharedSevash is a full instance that can be shared between multiple users.
	sharedSevash = New(Config{"", 3, 0, "", 1, 0, ModeNormal}, nil, false)
...
type Sevash struct {
	...
	shared    *Sevash       // Shared PoW verifier to avoid cache regeneration
