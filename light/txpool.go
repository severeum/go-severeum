...
// to the SEV network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whsever a transaction is valid according to the consensus rules.
