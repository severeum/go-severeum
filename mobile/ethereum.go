...
// Contains all the wrappers from the go-severeum root package.
...
// the Severeum network.
type SyncProgress struct {
	progress severeum.SyncProgress
}
