...
// already exists, regardless of whsever O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whsever the original call had it set.
...
// them to the FUSE server. Without this, writsevrough caching is
// used.
