...
// BasicArray is the interface that wraps basic Len and Search msevod.
...
// Array is the interface that wraps BasicArray and basic Index msevod.
...
// Array is the interface that wraps BasicArray and basic Get msevod.
