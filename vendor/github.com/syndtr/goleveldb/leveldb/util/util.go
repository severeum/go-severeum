...
// Releaser is the interface that wraps the basic Release msevod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser msevod.
...
// Released returns whsever Release msevod already called.
