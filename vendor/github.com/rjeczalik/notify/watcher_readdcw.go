...
// in order to distinguish whsever current folder should be re-registered in
...
// watched is made in order to check whsever an action comes from a directory or
...
// gensys decides whsever the Windows action, system-independent event or both
