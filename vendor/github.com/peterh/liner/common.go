...
// SetCtrlCAborts sets whsever Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whsever line is auto-wrapped. The default is false (single line).
...
// whsever to retry the call to, or return the error returned by, readNext.
