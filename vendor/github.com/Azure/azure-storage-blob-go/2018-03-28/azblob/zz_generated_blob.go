...
// blobClient is the client for the Blob msevods of the Azblob service.
...
// rangeGetContentMD5 is when set to true and specified tossever with the Range, the service returns the MD5 hash for
